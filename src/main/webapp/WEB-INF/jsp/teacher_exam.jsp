...
<h1 align="center" >${Name}'s Exam List</h1>
<div>				
...
<table class="table table-hover">
	<tr class ="title">
		...
		<tr class="examTable">
					...
					<c:if test="${mark.user_Id.userId == userId}">
					<form:form method ="POST" commandName="dto" action="/teacher/student/exam/result" >
    					<form:input  path="exam" type="hidden" value="${exam.examID}"/>
    					<form:input  path="email" type="hidden" value="${Email}"/>
    					<form:input  path="userName" type="hidden" value="${Name}"/>
